...
contract cLGE is Ownable, ReentrancyGuard {
    ...
    // This function is in case our pre-computed before address for a token that doesn't exist yet goes wrong.
    // Since we don't want to reveal ERC95 to maintain maximum competitive advantage
    // Or in case of a bug in the token wrap being discovered
